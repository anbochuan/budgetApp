...
var UIController = (function () {
    ...
    var formatNumber = function (num, type) {
        ...
        int = numSplit[0];
        if (int.length > 3) {
            // first argument is the index nnumber where we want to start
            // second argument is how many characters we want to read
            int = int.substr(0, int.length - 3) + ',' + int.substr(int.length - 3, 3);// input 1230, output 1,230
        }
        dec = numSplit[1];
